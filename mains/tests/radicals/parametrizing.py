...
new_rad = PDBMolecule.from_pdb("F.pdb")
g = new_rad.to_dgl()
topology = new_rad.to_openmm().topology
#%%
forcefield=ForceField('amber99sbildn.xml')
n_max_periodicities=6
suffix="_amber99sbildn"
parameters=["charge", "LJ", "bond", "angle", "torsion"]
energies=["charge", "LJ", "bond", "angle", "torsion", "improper", "nonbonded", "total", "bonded"]
forces=True
write_data=True
